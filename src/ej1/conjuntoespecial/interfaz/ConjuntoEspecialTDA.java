...
public interface ConjuntoEspecialTDA {
    ...
    public Respuesta sacar(int valor); // Elimina un valor del conjunto. La Respuesta devuelve el error en true si no se realiza una eliminación, false si se eliminó correctamente.
